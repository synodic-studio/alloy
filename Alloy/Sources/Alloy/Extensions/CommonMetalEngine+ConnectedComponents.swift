...
public extension CommonMetalEngine {
    ...
    func connectedComponents(maxComponents: Int = 50, maxPixelsPerBlob: Int = 100) throws -> CommonMetalEngine {
        // Validate parameters
    ...
    func executeConnectedComponentsWithTexture(inputTexture: MTLTexture, maxComponents: Int = 50, maxPixelsPerBlob: Int = 100) throws -> ConnectedComponentsResult {
    ...
    ///   - maxPixelsPerBlob: Maximum pixels per blob
    /// - Returns: ConnectedComponentsResult containing processed texture and detected centroids
    func executeConnectedComponents(data: Data, maxComponents: Int = 50, maxPixelsPerBlob: Int = 100) throws -> ConnectedComponentsResult {
        // Validate that engine has been configured with dimensions
        guard inputWidth > 0, inputHeight > 0 else {
