...
struct ErosionTests {
    ...
    func singleIteration4ConnectionErosion() throws {
    ...
    func singleIteration8ConnectionErosion() throws {
        // Create a simple 3x3 white square with black border
        let testImage = createTestImage(width: 5, height: 5, pattern: .whiteSquareWithBorder)
    ...
    func connectivityDifference() throws {
        ...
        let whiteCount4 = pixels4.count(where: { $0.r > 0 })
        let whiteCount8 = pixels8.count(where: { $0.r > 0 })
    ...
    func multipleIterations() throws {
    ...
    func singlePixelErosion() throws {
