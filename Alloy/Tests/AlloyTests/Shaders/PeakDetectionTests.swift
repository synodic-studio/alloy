...
struct PeakDetectionTests {
    ...
    func testPeakDetectionBasicFunctionality() throws {
    ...
    func testPeakDetectionFindsObviousPeak() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionHighThresholdFilters() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionRespectsMaxPeaks() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionRespectsMinDistance() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testDifferentNeighborhoodSizes() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionValidationInvalidNeighborhoodSize() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionValidationNegativeMinDistance() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionValidationInvalidThreshold() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func testPeakDetectionValidationZeroMaxPeaks() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
