...
struct ConnectedComponentsTests {
    ...
    func testSinglePixelComponent() throws {
    ...
    func testConnectedPixelsComponent() throws {
    ...
    func testMaxComponentsLimit() throws {
    ...
    func testMaxPixelsPerBlobFilter() throws {
        ...
        #expect(result.centroids.count == 0, "Large component should be filtered out by maxPixelsPerBlob")
    }
    
    @Test("Black pixels are ignored")
    func testBlackPixelsIgnored() throws {
        ...
        #expect(result.centroids.count == 0, "Should detect no components in all-black image")
    }
    
    @Test("Diagonal connectivity works correctly")
    func testDiagonalConnectivity() throws {
    ...
    func testErosionConnectedComponentsPipeline() throws {
    ...
    func testConnectedComponentsPerformance() throws {
