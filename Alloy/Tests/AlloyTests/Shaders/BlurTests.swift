...
struct BlurTests {
    ...
    func blurBasicFunctionality() throws {
    ...
    func blurPreservesAverageIntensity() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func blurValidationZeroRadius() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func blurValidationNegativeRadius() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func blurValidSmallRadius() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func blurValidLargeRadius() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func largerRadiusProducesMoreBlur() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func blurPreservesAlpha() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
