...
struct NoiseTests {
    ...
    func noiseBasicFunctionality() throws {
    ...
    func noiseZeroMagnitude() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func noiseStaysWithinBounds() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func sameSeedProducesSameNoise() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func differentSeedsProduceDifferentNoise() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func noiseValidationNegativeMagnitude() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func noiseValidationMagnitudeTooLarge() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func noiseValidMagnitudeZero() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func noiseValidMagnitudeOne() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func ignoreBlackPreservesBlackPixels() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func ignoreWhitePreservesWhitePixels() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func ignoreBlackDoesNotAffectNonBlackPixels() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func ignoreWhiteDoesNotAffectNonWhitePixels() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func bothIgnoreOptionsCanBeUsedTogether() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func ignoreBlackFalseAllowsNoiseOnBlackPixels() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func ignoreWhiteFalseAllowsNoiseOnWhitePixels() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func higherMagnitudeProducesMoreNoise() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
    ...
    func noisePreservesAlpha() throws {
        guard let engine = CommonMetalEngine() else { throw TestError.engineInitializationFailed }
